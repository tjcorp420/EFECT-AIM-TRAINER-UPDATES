...
export const SCENARIO_GAMEPLAY_CONFIGS: Record<string, Partial<ScenarioGameplayConfig>> = {
  ...
  neon_popcorn: {
    ...
    targetSpeed: 2.25,
    targetDistance: -10,
    botVisuals: { ...DEFAULT_GAMEPLAY_CONFIG.botVisuals, aura: 'vertical', ringOpacity: 0.22 },
    arena: {
    ...
    benchmark: { playlist: 'warmup', category: 'WARMUPS', percentileBaseline: 36000 },
  },
  void_cluster: {
    targetAmount: 7,
    targetSize: 0.72,
    targetSpeed: 1.35,
    targetDistance: -11,
    botVisuals: { ...DEFAULT_GAMEPLAY_CONFIG.botVisuals, aura: 'grid', ringOpacity: 0.18 },
    arena: {
      ...DEFAULT_GAMEPLAY_CONFIG.arena,
      brightness: 1.3,
      propStyle: 'gridwall',
    ...
    benchmark: { playlist: 'warmup', category: 'FLICK_TRAINING', percentileBaseline: 44000 },
  },
  glider_tracking_night: {
    targetAmount: 1,
    targetHp: 145,
    targetSize: 0.82,
    targetSpeed: 1.95,
    ...
    arena: {
      ...DEFAULT_GAMEPLAY_CONFIG.arena,
      brightness: 1.22,
      propStyle: 'tracking_lane',
      accent: '#00ffcc',
    },
    benchmark: { playlist: 'voltaic', category: 'TRACKING_TRAINING', percentileBaseline: 47000 },
  },
  gridshot_standard: {
    targetAmount: 3,
...
export const SCENARIOS: readonly ScenarioData[] = [
  ...
  withDefaults({
    ...
    name: 'NEON POPCORN',
    shortName: 'NEON POP',
    desc: 'Fast vertical bounce targets with bright outline reads.',
    type: 'DYNAMIC',
    difficulty: 'ELITE',
    focus: 'VERTICAL REACTIVITY',
    icon: 'N',
    skill: 'VERTICAL_TIMING',
    recommendedWeapon: 'pistol',
    recommendedDuration: 45,
    targetSpeedPreset: 2.25,
    targetScalePreset: 0.68,
    targetDistancePreset: -10,
    tags: ['vertical', 'popcorn', 'reaction', 'neon', 'warmup'],
    coachUseCase: 'Use this when the player needs cleaner vertical reads and fast height changes.',
    category: 'WARMUPS',
    benchmarkWeight: 1.35,
  }),
  withDefaults({
    id: 'void_cluster',
    name: 'VOID CLUSTER',
    shortName: 'CLUSTER',
    desc: 'Tight target clusters for fast swaps without overflicking.',
    type: 'FLICK',
    difficulty: 'ADVANCED',
    focus: 'CONTROLLED SWITCHING',
    icon: 'C',
    skill: 'TARGET_SWITCHING',
    recommendedWeapon: 'pistol',
    recommendedDuration: 60,
    targetSpeedPreset: 1.35,
    targetScalePreset: 0.72,
    targetDistancePreset: -11,
    tags: ['cluster', 'flick', 'control', 'dark', 'switching'],
    coachUseCase: 'Use this when the player moves too far between nearby targets.',
    category: 'FLICK_TRAINING',
    rankedEnabled: true,
    benchmarkWeight: 1.2,
  }),
  withDefaults({
    id: 'glider_tracking_night',
    name: 'GLIDER NIGHT TRACK',
    shortName: 'GLIDER',
    desc: 'Wide sweeping glider movement for smooth tracking discipline.',
    type: 'TRACKING',
    difficulty: 'ELITE',
    focus: 'SMOOTH GLIDE TRACKING',
    icon: 'G',
    skill: 'SMOOTH_TRACKING',
    recommendedWeapon: 'smg',
    recommendedDuration: 60,
    targetSpeedPreset: 1.95,
    targetScalePreset: 0.82,
    targetDistancePreset: -15,
    tags: ['tracking', 'glider', 'smooth', 'night', 'ranked'],
    coachUseCase: 'Use this when the player loses smoothness during long crossing movement.',
    category: 'TRACKING_TRAINING',
    rankedEnabled: true,
    benchmarkWeight: 1.45,
  }),
  withDefaults({
  ...
  withDefaults({
    id: 'sixshot_precision',
    name: 'SIXSHOT PRECISION',
    shortName: 'SIXSHOT',
    desc: 'Six tiny targets for clean click timing.',
    type: 'PRECISION',
    difficulty: 'ELITE',
    focus: 'CLICK TIMING',
    icon: '6',
    ...
    targetScalePreset: 0.48,
    targetDistancePreset: -11,
    tags: ['sixshot', 'precision', 'micro', 'ranked'],
    coachUseCase: 'Use this when small target confirmation and micro-correction are inconsistent.',
    rankedEnabled: true,
  }),
  withDefaults({
    id: 'tile_frenzy',
    name: 'TILE FRENZY',
    shortName: 'TILE',
    desc: 'Large high-speed wall targets for raw speed.',
    type: 'FLICK',
    difficulty: 'STANDARD',
    focus: 'RAW SPEED',
    icon: '#',
    ...
    recommendedDuration: 60,
    targetSpeedPreset: 1.35,
    targetScalePreset: 1.25,
    targetDistancePreset: -8,
    tags: ['tile', 'speed', 'flick', 'warmup'],
    coachUseCase: 'Use this when the player needs a fast warmup with forgiving target size.',
  }),
  withDefaults({
    id: 'tile_frenzy_mini',
    name: 'TILE FRENZY MINI',
    shortName: 'MINI TILE',
    desc: 'Smaller tile field for speed plus accuracy.',
    type: 'PRECISION',
    difficulty: 'ADVANCED',
    ...
    targetScalePreset: 0.72,
    targetDistancePreset: -9,
    tags: ['tile', 'speed', 'precision'],
    coachUseCase: 'Use this when raw speed is good but target precision drops.',
  }),
  withDefaults({
    id: 'multishot_speed',
    name: 'MULTISHOT SPEED',
    shortName: 'MULTISHOT',
    desc: 'Dense target field with fast confirmation rhythm.',
    type: 'FLICK',
    difficulty: 'ADVANCED',
    focus: 'CONFIRMATION RHYTHM',
    icon: '+',
    skill: 'TARGET_SWITCHING',
    recommendedWeapon: 'pistol',
    recommendedDuration: 60,
    ...
    targetDistancePreset: -10,
    tags: ['multishot', 'speed', 'switching'],
    coachUseCase: 'Use this when the player needs faster target confirmation without losing rhythm.',
  }),
  withDefaults({
  ...
  withDefaults({
    ...
    shortName: 'MICROSHOT',
    desc: 'Rapid small-target confirmations.',
    type: 'PRECISION',
    difficulty: 'ELITE',
    focus: 'MICRO CONFIRMATION',
    icon: '.',
    skill: 'MICRO_CORRECTION',
    recommendedWeapon: 'pistol',
    recommendedDuration: 45,
    targetSpeedPreset: 1.45,
    targetScalePreset: 0.5,
    targetDistancePreset: -10,
    tags: ['microshot', 'speed', 'precision', 'reaction'],
    coachUseCase: 'Use this when the player sees small targets quickly but confirms too slowly.',
    rankedEnabled: true,
  }),
  withDefaults({
    id: 'headshot_only',
    name: 'HEADSHOT ONLY',
    shortName: 'HEADSHOT',
    desc: 'Humanoid precision drill built around head conversion.',
    type: 'PRECISION',
    difficulty: 'ADVANCED',
    focus: 'HEADSHOT CONVERSION',
    icon: 'H',
    skill: 'MICRO_CORRECTION',
    recommendedWeapon: 'pistol',
    recommendedDuration: 60,
    ...
    targetScalePreset: 0.9,
    targetDistancePreset: -9,
    tags: ['headshot', 'humanoid', 'precision', 'fortnite'],
    coachUseCase: 'Use this when crosshair height and headshot conversion are weak.',
  ...
  withDefaults({
    id: 'tracking_long_strafe',
    name: 'LONG STRAFE TRACK',
    shortName: 'LONG STRAFE',
    desc: 'Wide predictable strafes for smooth mouse control.',
    type: 'TRACKING',
    difficulty: 'STANDARD',
    focus: 'LONG STRAFE CONTROL',
    icon: '<>',
    skill: 'SMOOTH_TRACKING',
    recommendedWeapon: 'smg',
    recommendedDuration: 60,
    targetSpeedPreset: 0.95,
    targetScalePreset: 1,
    targetDistancePreset: -15,
    tags: ['tracking', 'long-strafe', 'smooth', 'warmup'],
    coachUseCase: 'Use this when the player needs smoother long tracking lines.',
    rankedEnabled: true,
  }),
  withDefaults({
    id: 'tracking_dodge',
    name: 'DODGE TRACKING',
    shortName: 'DODGE',
    desc: 'Targets dodge with short unpredictable bursts.',
    type: 'TRACKING',
    difficulty: 'ELITE',
    focus: 'DODGE READS',
    icon: '<>',
    ...
    recommendedWeapon: 'smg',
    recommendedDuration: 60,
    targetSpeedPreset: 1.8,
    targetScalePreset: 0.9,
    targetDistancePreset: -14,
    tags: ['tracking', 'dodge', 'strafe', 'ranked'],
    coachUseCase: 'Use this when tracking breaks during short dodge bursts.',
  }),
  withDefaults({
    id: 'tracking_sphere',
    name: 'SPHERE TRACKING',
    shortName: 'SPHERE',
    desc: 'Floating target with mixed horizontal and vertical motion.',
    type: 'TRACKING',
    difficulty: 'ADVANCED',
    focus: 'FLOATING TRACK',
    icon: 'O',
    skill: 'SMOOTH_TRACKING',
    recommendedWeapon: 'smg',
    recommendedDuration: 60,
    targetSpeedPreset: 1.25,
    targetScalePreset: 0.95,
    targetDistancePreset: -14,
    tags: ['tracking', 'sphere', 'vertical'],
    coachUseCase: 'Use this when the player struggles to track mixed horizontal and vertical motion.',
  }),
  withDefaults({
    id: 'switchtrack_standard',
    name: 'SWITCHTRACK',
    shortName: 'SWITCHTRACK',
    desc: 'Swap between multiple moving targets cleanly.',
    type: 'TRACKING',
    difficulty: 'ADVANCED',
    focus: 'TRACK SWITCHING',
    icon: 'S',
    skill: 'TARGET_SWITCHING',
    recommendedWeapon: 'smg',
    recommendedDuration: 60,
    ...
    targetScalePreset: 0.95,
    targetDistancePreset: -14,
    tags: ['tracking', 'switching', 'target-switch'],
    coachUseCase: 'Use this when the player loses control while switching between moving targets.',
    rankedEnabled: true,
  }),
  withDefaults({
    id: 'switchtrack_micro',
    name: 'MICRO SWITCHTRACK',
    shortName: 'MICRO SWITCH',
    desc: 'Small moving targets for fast tracking swaps.',
    type: 'TRACKING',
    difficulty: 'ELITE',
    focus: 'MICRO TRACK SWITCHING',
    icon: 'S',
    skill: 'STRAFE_READING',
    recommendedWeapon: 'smg',
    recommendedDuration: 60,
    targetSpeedPreset: 1.55,
    targetScalePreset: 0.65,
    targetDistancePreset: -14,
    tags: ['tracking', 'micro', 'switching', 'ranked'],
    coachUseCase: 'Use this when switching to small moving targets is inconsistent.',
  }),
  withDefaults({
    id: 'popcorn_standard',
    name: 'POPCORN',
  ...
  withDefaults({
    ...
    name: 'PASU JUMP',
    shortName: 'PASU',
    desc: 'Airborne targets with lateral drift and vertical timing.',
    type: 'DYNAMIC',
    difficulty: 'ADVANCED',
    focus: 'AIRBORNE READS',
    icon: 'P',
    ...
    targetScalePreset: 0.9,
    targetDistancePreset: -12,
    tags: ['pasu', 'airborne', 'vertical', 'dynamic'],
    coachUseCase: 'Use this when airborne target reads and vertical timing feel late.',
  }),
  withDefaults({
    id: 'vertical_switch',
    name: 'VERTICAL SWITCH',
    shortName: 'VERT SWITCH',
    desc: 'High-low target swaps for elevation control.',
    type: 'DYNAMIC',
    difficulty: 'ADVANCED',
    focus: 'HIGH LOW SWITCHING',
    icon: 'V',
    skill: 'VERTICAL_TIMING',
    recommendedWeapon: 'pistol',
    recommendedDuration: 60,
    ...
    targetScalePreset: 0.85,
    targetDistancePreset: -11,
    tags: ['vertical', 'switching', 'dynamic'],
    coachUseCase: 'Use this when high-low target swaps pull the crosshair off line.',
  }),
  withDefaults({
  ...
  withDefaults({
    id: 'flick360_precision',
    name: '360 PRECISION',
    shortName: '360 PREC',
    desc: 'Small surround targets for controlled turns.',
    type: 'PRECISION',
    difficulty: 'ELITE',
    focus: 'CONTROLLED FULL TURNS',
    icon: '360',
    skill: 'SPATIAL_AWARENESS',
    recommendedWeapon: 'pistol',
    recommendedDuration: 60,
    targetSpeedPreset: 1.15,
    targetScalePreset: 0.62,
    targetDistancePreset: -12,
    tags: ['360', 'precision', 'awareness', 'ranked'],
    coachUseCase: 'Use this when full-turn aim lands close but needs final micro-correction.',
  }),
  withDefaults({
  ...
  withDefaults({
    id: 'spidershot_precision',
    name: 'SPIDERSHOT PRECISION',
    shortName: 'SPIDER PREC',
    desc: 'Tiny center-return flicks.',
    type: 'PRECISION',
    difficulty: 'ADVANCED',
    focus: 'CENTER MICRO RESET',
    icon: '*',
    skill: 'CENTER_RESET',
    recommendedWeapon: 'pistol',
    recommendedDuration: 60,
    targetSpeedPreset: 1,
    targetScalePreset: 0.58,
    targetDistancePreset: -10,
    tags: ['spidershot', 'precision', 'center', 'micro'],
    coachUseCase: 'Use this when center-return discipline is good but tiny targets are missed.',
    rankedEnabled: true,
  }),
  withDefaults({
  ...
  withDefaults({
    ...
    shortName: 'REACTIVE',
    desc: 'Targets appear in quick alternating lanes.',
    type: 'REACTION',
    difficulty: 'ELITE',
    focus: 'REACTIVE SWITCHING',
    icon: 'R',
    skill: 'REACTION_SPEED',
    recommendedWeapon: 'pistol',
    recommendedDuration: 45,
    ...
    targetScalePreset: 0.82,
    targetDistancePreset: -10,
    tags: ['reaction', 'switching', 'lanes', 'ranked'],
    coachUseCase: 'Use this when the player is slow to react across alternating lanes.',
    rankedEnabled: true,
  }),
  withDefaults({
    id: 'close_strafe_flick',
    name: 'CLOSE STRAFE FLICK',
    shortName: 'CLOSE STRAFE',
    desc: 'Close targets with lateral motion and fast scoring.',
    type: 'FLICK',
    difficulty: 'ADVANCED',
    focus: 'CLOSE STRAFE CONTROL',
    icon: 'C',
    skill: 'FORTNITE_PUMP',
    recommendedWeapon: 'pistol',
    recommendedDuration: 60,
    targetSpeedPreset: 1.5,
    targetScalePreset: 1,
    targetDistancePreset: -7,
    tags: ['close', 'strafe', 'fortnite', 'flick'],
    coachUseCase: 'Use this when close-range strafing targets pull the crosshair wide.',
    category: 'FORTNITE_TRAINING',
  }),
  withDefaults({
