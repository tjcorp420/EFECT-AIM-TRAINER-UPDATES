...
const SCENARIOS = [
  ...
  // ELITE TRACKING & FLICKING DRILLS
...
export default function ScenarioSelect() {
  ...
  // Generates a raw config string that players can share or export
  const exportConfig = () => {
  ...
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, width: '100vw', height: '100vh', background: 'url(/bg-blur.jpg) center/cover, #0a0a0a', zIndex: 50, display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '60px', fontFamily: 'monospace', color: '#fff', overflow: 'hidden' }}>
      ...
      {/* TOP NAVIGATION INFO */}
      <div style={{ position: 'absolute', top: '25px', left: '40px', display: 'flex', gap: '20px' }}>
        ...
        >
          {copied ? '✓ CONFIG COPIED' : '⎘ EXPORT CONFIG'}
        </button>
      </div>
      ...
      <div style={{ 
        width: '95%', maxWidth: '1600px', height: '75vh', overflowY: 'auto', padding: '20px',
